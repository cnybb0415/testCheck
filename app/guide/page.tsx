  ...
  return (
    <div className="min-h-screen px-6 py-10 sm:px-12">
      <main className="mx-auto max-w-3xl">
        ...
        <h1 className="mt-3 text-2xl font-bold">학습 가이드</h1>
        <p className="mt-1 text-sm text-black/60 dark:text-white/60">
          정보처리기사 실기 시험 정보와 단기 합격 전략을 정리했습니다.
        </p>

        {!loading && attempted.length > 0 && (
          <section className="mt-6 rounded-lg border border-amber-500/30 bg-amber-500/10 p-4">
            <h2 className="text-sm font-semibold text-amber-700 dark:text-amber-400">지금 가장 신경 써야 할 단원</h2>
            ...
            <div className="mt-3 flex gap-3 text-sm">
              <Link href="/wrong-notes" className="underline">오답노트 보기</Link>
              <Link href="/cards?source=wrong" className="underline">약점 카드로 복습</Link>
            </div>
          </section>
        )}

        <section className="mt-8">
          <h2 className="text-lg font-semibold">시험 개요</h2>
          <ul className="mt-3 space-y-1.5 text-sm text-black/80 dark:text-white/80">
        ...
        <section className="mt-8">
          <h2 className="text-lg font-semibold">과목별 배점 (참고용, 회차마다 변동 가능)</h2>
          <ul className="mt-3 space-y-1.5 text-sm text-black/80 dark:text-white/80">
        ...
        <section className="mt-8">
          <h2 className="text-lg font-semibold">단기간(4~6주) 합격 전략</h2>
          <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm text-black/80 dark:text-white/80">
            <li>
              <span className="font-medium">눈으로 읽지 말고 직접 풀기.</span> 실기는 주관식이라 &quot;아는 것 같다&quot;와 &quot;답을 쓸 수 있다&quot;는 다릅니다.
              이 사이트의 기출문제 풀기/카드퀴즈로 매번 직접 답을 적어보세요.
            </li>
            <li>
              <span className="font-medium">100점이 아니라 60점(12문항)을 목표로 설계.</span> 자신 있는 단원부터 확실히 잡고,
              약점 단원은 오답노트에서 반복 노출시키는 방식이 효율적입니다.
            </li>
            <li>
              <span className="font-medium">비전공자는 코드/SQL 트레이싱에 가장 많은 시간을 배정.</span>
              C/Java/Python 기본 문법 → 제어문·함수·배열·포인터·클래스 순으로 한 줄씩 손으로 따라가며 결과를 예측하는 연습이 핵심입니다.
            </li>
            <li>
              <span className="font-medium">쉬운 회차를 노리기보다 어떤 회차든 60점을 넘기는 실력을 목표.</span>
              특정 회차가 어려우면 다음 회차가 쉬워지는 경향이 있지만, 난이도를 예측해 전략을 짜는 것보다 기본기를 확실히 하는 편이 안전합니다.
            </li>
            <li>
              <span className="font-medium">매일 오늘의 문제 + 약점 카드퀴즈로 짧게 반복.</span> 한 번에 몰아서 푸는 것보다
        ...
        <section className="mt-8">
          <h2 className="text-lg font-semibold">답안 작성 팁</h2>
          <ul className="mt-3 space-y-1.5 text-sm text-black/80 dark:text-white/80">
        ...
        <section className="mt-8">
          <h2 className="text-lg font-semibold">참고할 만한 자료</h2>
          <ul className="mt-3 space-y-2 text-sm">
            <li>
              <a href="https://www.youtube.com/@weekendcode" target="_blank" rel="noopener noreferrer" className="font-medium underline">
                주말코딩 (YouTube)
              </a>
            ...
            <li>
              ...
              <p className="text-black/60 dark:text-white/60">단기 합격 후기가 많이 언급되는 강좌.</p>
            </li>
            <li>
              <a href="https://namu.wiki/w/정보처리기사/출제경향" target="_blank" rel="noopener noreferrer" className="font-medium underline">
                나무위키 · 정보처리기사/출제경향
              </a>
              <p className="text-black/60 dark:text-white/60">과목별 출제 비중과 최근 경향을 정리한 문서.</p>
            </li>
            <li>
              <a href="https://www.q-net.or.kr/crf005.do?id=crf00503&jmCd=1320" target="_blank" rel="noopener noreferrer" className="font-medium underline">
                Q-net · 정보처리기사 국가자격 상세정보
              </a>
              <p className="text-black/60 dark:text-white/60">공식 출제기준, 시행 일정 등 원본 자료.</p>
            </li>
          </ul>
        </section>
      </main>
